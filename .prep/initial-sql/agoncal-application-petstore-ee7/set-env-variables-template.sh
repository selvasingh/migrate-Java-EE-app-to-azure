...
export SQL_SERVER_NAME=<my sql server name>
export SQL_SERVER_ADMIN_LOGIN_NAME=<my sql server admin login name>
export SQL_SERVER_ADMIN_PASSWORD=<my sql sever admin password>
export SQL_DATABASE_NAME=<my sql database name>
